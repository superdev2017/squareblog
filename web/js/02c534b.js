...
function advancedBuilderNotAuthorized() {
  swal({
    ...
    text: 'You do not have access to the advanced builder. Please contact support to upgrade your plan.',
    type: "error",
    confirmButtonText: "Ok"
  });
  return false;
...
$(function() {
    ...
    $(this).mouseup(function(login) {
        if(!($(login.target).parent('.login-menu').length > 0)) {
            button.removeClass('active');
            box.hide();
        }
    });
